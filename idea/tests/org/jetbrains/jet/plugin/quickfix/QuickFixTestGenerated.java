...
public class QuickFixTestGenerated extends AbstractQuickFixTest {
    ...
    public static class AutoImports extends AbstractQuickFixTest {
        ...
        @TestMetadata("beforeNoImportAndFailForInvalidClassObject.kt")
        public void testNoImportAndFailForInvalidClassObject() throws Exception {
            doTest("idea/testData/quickfix/autoImports/beforeNoImportAndFailForInvalidClassObject.kt");
        }
